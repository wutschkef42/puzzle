...
export default {
  ...
  mounted: function() {
        ...
        frame.on("ready", function()
        {
            ...
            frame.loadAssets(["background.jpg"], "assets/");
            frame.on("complete", function() {
                imageObj = frame.asset("background.jpg").clone();
                imageObj.addTo(con);
                imageObj.alpha = 0.2;
                    ...
                    for (var i = 0; i < horizontalPieces; i++) {
                        ...
                        s.addEventListener("pressup", function(e) {
                            ...
                            if (xx < puzzleX+gap / 2 && xx > puzzleX-gap / 2 && yy < puzzleX+gap / 2 && yy > puzzleY-gap / 2) {
                                ...
                                {
                                    var pane = new Pane({width:600,label:"Parfait!", height:250, modal:false, displayClose:false});
